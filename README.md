...
`blume`, `sonne`, eigene Bild-Motive aus `lib/motifs.js` wie `zwinker`; beim Bildmagneten `fuchs`, `eule`, `panda`, `hase`; Muster und Motiv schließen sich aus, bei beiden gilt das Motiv), `paper` (`glatt`, `liniert`, `kariert`),
