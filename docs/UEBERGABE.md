...
| 1.39.0 | Bildmagnet `poodle` (Pudel, fotorealistisch, Platte Petrol) aus dem einzigen Foto des Auftraggebers, `gpt_image2_edit` mit Lola als Stilvorlage, drei Plattenfarben erzeugt (Salbei, Himmelblau, Petrol), Petrol eingebaut | Registry `lib/motifs.js` jetzt **540 KB** – Budget ~600 KB praktisch erreicht; vor dem nächsten Motiv WebP-Qualität in `prep_photo.mjs` senken oder alte Motive entfernen. Entstand parallel zur Sitzung 1.35.3–1.38.0 und wurde auf deren Stand umgesetzt |
