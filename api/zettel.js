...
//   fcolor: rot | blau | gruen | gelb | silber | schwarz · fpattern: streifen | punkte | karo · fdesign (Magnet): smiley | herz | stern | pfote | blume | sonne · scale: 60–140
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { png } = await renderZettel({ text: t, color: q.color, font: q.font, fastener: q.fastener, fastenerColor: q.fcolor, fastenerPattern: q.fpattern, fastenerDesign: q.fdesign, fontScale: q.scale, list: q.list, w, h });
    res.status(200);
