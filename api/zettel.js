...
export default async function handler(req, res) {
  ...
  try {
    ...
    const { png } = await renderZettel({ text: t, color: q.color, font: q.font, fastener: q.fastener, fastenerColor: q.fcolor, fastenerPattern: q.fpattern, fastenerDesign: q.fdesign, paper: q.paper, pen: q.pen, texture: q.texture, edge: q.edge, fontScale: q.scale, list: q.list, w, h });
    res.status(200);
