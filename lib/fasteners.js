...
(function (root, factory) {
  ...
  function setMotifs(reg) {
    for (const [k, m] of Object.entries(reg || {})) {
      MOTIFS[k] = m; DESIGNS[k] = m.label; DECOR_LABEL[k] = m.label; DESIGN_ALIAS[m.label.toLowerCase()] = k;
  ...
  return { FASTENERS, FASTENER_INSET, FCOLORS, FCOLOR_DEFAULT, PATTERNS, PATTERN_SUPPORT, DESIGNS, DESIGN_SUPPORT, DECOR_LABEL, decorsFor,
    normalizeFastener, normalizeLook, lookKey, fastenerShapes, fastenerIcon, fastenerSvg, setMotifs, magnetGeometry, magnetGlint, motifSrc };
});
