...
export async function renderZettel({ text, color = 'yellow', font = 'caveat', fastener = 'tape', fastenerPos, fastenerVier, fastenerColor, fastenerPattern, fastenerDesign, paper = 'plain', pen = 'black', texture = 'smooth', edge = 'straight', fontScale = 100, list = 'none', title = false, titleSize = 1, noteScale, noteX, noteY, noteFit, noteRot, bg = 'dark', w = 2360, h = 2360 }) {
  ...
  // Der Schriftregler schrumpft den ganzen Zettel, nicht nur die Schrift – gleiche Rechnung und
  // gleiche Klemmung wie in fitNote (index.html), wo die Begründung steht.
  const noteW = Math.round(layout.noteW * klemm(nScale * scale, 0.3, 1.15));
  ...
  // Der Nutzer-Regler steckt seit 3.40 schon in noteW – die Schrift folgt ihm über minFs, paraFloor
  // und den Startwert noteW/7 von selbst, genau wie in index.html.
