...
function fastenerShapes(kind, W, H, p) {
  ...
  const pushpin = (cx, cy, s, deg) => `<g transform="translate(${cx} ${cy}) rotate(${deg}) scale(${s})">
    ...
    <ellipse cx="0" cy="0.93" rx="0.56" ry="0.2" fill="#9c1e17"/><rect x="-0.56" y="0.85" width="1.12" height="0.08" fill="#9c1e17"/><ellipse cx="0" cy="0.85" rx="0.56" ry="0.2" fill="#e0342b"/>
    <rect x="-0.2" y="0.1" width="0.4" height="0.78" fill="#c8281f"/><rect x="-0.2" y="0.1" width="0.13" height="0.78" fill="#ff5147" fill-opacity=".55"/>
    <ellipse cx="0" cy="0.14" rx="0.5" ry="0.25" fill="#a8201a"/><rect x="-0.5" y="0" width="1" height="0.14" fill="#c8281f"/><ellipse cx="0" cy="0" rx="0.5" ry="0.25" fill="#ff3b30"/>
    <ellipse cx="-0.16" cy="-0.07" rx="0.17" ry="0.08" fill="#ffa39d" fill-opacity=".8"/></g>`;
  switch (kind) {
    case 'tape2':     return tape(p * 0.7, p * 0.7, W * 0.24, p * 0.8, -45) + tape(W - p * 0.7, p * 0.7, W * 0.24, p * 0.8, 45); // über die Ecken, etwas ins Papier
    case 'thumbtack': return thumbtack(W / 2, -p * 0.12, p * 1.05, -10); // Kopf ragt über die Oberkante
    case 'pushpin':   return pushpin(W / 2, -p * 0.75, p * 1.7, -12);
