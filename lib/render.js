...
export async function renderZettel({ text, color = 'yellow', font = 'caveat', fastener = 'tape', fastenerPos, fastenerVier, fastenerColor, fastenerPattern, fastenerDesign, paper = 'plain', pen = 'black', texture = 'smooth', edge = 'straight', fontScale = 100, list = 'none', title = false, titleSize = 1, bg = 'dark', w = 2360, h = 2360 }) {
      ...
      children: [
        ...
        { type: 'div', props: { style: {
          ...
          { type: 'div', props: { style: {
            ...
            if (!m) return { type: 'div', props: { style: { ...body, ...head, ...durch, width: textW, minHeight: fs * F.lh * (titleOn && pi === 0 ? tF : 1) }, children: para || ' ' } };
            ...
            return { type: 'div', props: { style: { display: 'flex', flexDirection: 'row', width: textW, ...head }, children: [
              ...
              { type: 'div', props: { style: { ...body, ...durch, width: textW - indent }, children: para.slice(m[0].length) } },
            ] } };
          }) } },
          fastenerSvg,
          ...motifNodes,
