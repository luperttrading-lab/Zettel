...
export async function renderZettel({ text, color = 'yellow', font = 'caveat', fastener = 'tape', fastenerColor, fastenerPattern, fastenerDesign, paper = 'plain', pen = 'black', texture = 'smooth', edge = 'straight', fontScale = 100, list = 'none', title = false, titleSize = 1, w = 2360, h = 2360 }) {
  ...
  return { png: Buffer.from(png), svg, w, h, layout: layoutName, fontSize: fs, lines, font: fontKey, fastener: kind, title: titleOn, titleSize: tSize };
}
